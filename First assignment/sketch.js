...
function drawTrees(){ // draws the 5 trees on screen
  ...
  let loghieght = log *4;
  let treeAmount =5
  let upshift = loghieght* 0.2 +40;
  let upshift2 = upshift+65;
let treex 
...
treex = secondx/1.6
  ...
  fill("green")
  leaves = width * 0.17;
  triangle(secondx *tree - leaves/2.7- treex , base - upshift, secondx*tree + leaves/1.7- treex ,base-upshift, secondx*tree + log/2- treex, base - upshift2)
  upshift = upshift + 40;
  upshift2 = upshift2 + 40;
  leaves = leaves*0.6
  triangle(secondx *tree- leaves/2- treex, base - upshift, secondx*tree + leaves/2- treex + log ,base-upshift, secondx*tree + log/2- treex, base - upshift2)
  upshift = upshift + 40;
  upshift2 = upshift2 + 40;
  leaves = leaves*0.7
  triangle(secondx*tree - leaves/2- treex, base - upshift, secondx*tree + leaves/2- treex + log ,base-upshift, secondx*tree + log/2- treex, base - upshift2)
